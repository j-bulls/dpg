...
@section('main')
	<!-- #code here -->
	<div class="qxp-bg qxp-financial-bg" style="display: flex;justify-content: center;align-items: center;width:100%;">
	...
	<div class="container" >
		<div class="row" style="margin: 80px auto;">
			...
			<div class="col-md-7 col-sm-12" style="">
				<img style="border-radius: 5px 5px 5px 5px;box-shadow: 0px 0px 30px -7px rgba(0, 0, 0, 0.2);" src="{{asset('images/featured/financial-money.jpg')}}" height="100%" width="100%" />
			</div>
		</div>
