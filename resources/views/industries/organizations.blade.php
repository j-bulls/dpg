...
@section('main')
	<!-- #code here -->
	<div class="qxp-bg qxp-organizations-bg" style="display: flex;justify-content: center;align-items: center;width:100%;">
		<div class="qxp-overlay qxp-overlay-resources"></div>
			<div class="container " style="height: 200px;">
				<div class="row">
					<div class="col-6">
						<div class="spacer" >
							<h1 style="color:#FFFFFF;font-size:21px;font-weight: 800;text-transform: uppercase;letter-spacing: 5px;">GOVERNMENT AND NON-PROFIT ORGANIZATIONS
							</h1>
	...
	<div class="container" >
		<div class="row" style="margin: 80px auto;">
			<div class="col-md-5 col-sm-12" style="">
				...
				<p style="margin: 20px 0px;color:#484848;font-size: 1.1em;">Speed productivity helps you work smarter and direct people to what matters most to them. Collaborative video conferencing assists in coordinating critical field work nad negotiations that works out for people</p>

			</div>
			<div class="col-md-7 col-sm-12" style="">
				<img style="border-radius: 5px 5px 5px 5px;box-shadow: 0px 0px 30px -7px rgba(0, 0, 0, 0.2);" src="{{asset('images/featured/organizations-2.jpg')}}" height="100%" width="100%" />
			</div>
		</div>
